export const defaultPortfolio = {
  ...
  socials: [
    { label: "GitHub", href: "https://github.com/Reshabhdev" },
    {
      label: "LinkedIn",
      href: "https://www.linkedin.com/in/rishabh-dev-singh-261183253",
    },
    { label: "Email", href: "mailto:dsrishabh@gmail.com" },
  ],
  metrics: [
    { label: "Passout year", value: "2026" },
    { label: "Projects built", value: "2" },
    { label: "Certifications", value: "4" },
  ],
  skills: [
    { category: "Programming", items: ["Python", "Machine Learning"] },
